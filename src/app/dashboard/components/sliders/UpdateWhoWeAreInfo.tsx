...
const UpdateWhoWeAreInfo = ({ setOpenModalForUpdate }: { setOpenModalForUpdate: (value: boolean) => void }) => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, whoWeAreData }: { id: string; whoWeAreData: Partial<TWhoWeAre> }) => {
      const response = await apiClient.patch(`/features/${id}`, { whoWeAre: whoWeAreData });
          ...
          <div className='max-w-4xl 2xl:mt-28 px-6 pt-10 flex flex-col  gap-10 justify-between items-center pb-20'>
            {videoUrl || videoId ? (
              <div className="w-[150px] h-[150px] relative">
                ...
                <Image alt='photo' src="/Images/videoUploadLogo.jpg" height={600} width={800} className='w-[160px] h-[120px] ' />
            ...
            <TextField
              ...
              multiline
              className='md:w-[350px] w-[250px] bg-white' id="outlined-multiline-static" label="Sort Description" variant="outlined" rows={4} />
