...
<div className='h-[calc(100vh-60px)]  overflow-auto border-r-2'>
{
  ...
  className={`py-3 pl-4 border-b hover:bg-gray-100 ${pathName === route.path?'bg-gray-300 text-[#3D93C1] font-semibold':'text-gray-700 bg-white'}`}
  >
...
<Link href={'/dashboard/'}><p className='flex items-center gap-2'> <span ><CiLogout /></span>Log Out</p></Link>
</div>
        </AccordionDetails>
</Accordion>       
</div>
