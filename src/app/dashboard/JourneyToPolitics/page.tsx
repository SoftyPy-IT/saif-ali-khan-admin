...
const JourneyToPolitics = () => {
  ...
  const {
    data: journeyToPoliticsData = { data: [], totalCount: 0 },
    isLoading,
  } = useQuery({
    queryKey: ["journeyToPolitics", currentPage],
    queryFn: async () => {
      const response = await axiosPublic.get(
        `/journey-to-politics?page=${currentPage}&limit=${limit}`
      );
      ...
      <div className="relative ">
        ...
        >
          <div className="mt-8">
            ...
            <UpdateJourneyInfo
              journeyToPoliticsId={updateJourneyToPoliticsId}
                        ...
                        <TableCell align="left">
                          <div className="flex items-center gap-3">
                            <button
                              onClick={() => {
                                setOpenModalForUpdate(!openModalForUpdate);
                                setJourneyToPoliticsId(row._id);
                              }}
