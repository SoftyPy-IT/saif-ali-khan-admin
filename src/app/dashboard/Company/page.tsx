...
import UpdateCompanyInfo from '../components/sliders/UpdateCompanyInfo';
...
const Company = () => {
  ...
  const  companyData:TCompany = (features as TFeatures)?.company;
  return (
...
<UpdateCompanyInfo setOpenModalForUpdate={setOpenModalForUpdate}/>
</div>
</div>
     ...
     <h1 className='lg:text-4xl text-xl font-semibold text-orange-500 '>Company </h1>
      ...
      <Table sx={{ width:'100%',border:"2px solid gray" }} aria-label="simple table">
        <TableHead className='bg-blue-200 border-b-2 border-gray-600'>
          <TableRow>
            ...
            <TableCell align='left'  className='text-gray-900 font-semibold'>Logo</TableCell>
            <TableCell align='left'  className='text-gray-900 font-semibold'>Company Name</TableCell>
            ...
            <TableCell align='left'  className='text-gray-900 font-semibold'>Website</TableCell>
        ...
        <TableBody>
            ...
            >
              <TableCell component="th" scope="row">
               <Image className='w-[100px] h-[100px]' alt='photo' src={companyData?.bgImageUrl} width={100} height={100}/>
              </TableCell>
              <TableCell align="left">
              <Image className='w-[100px] h-[100px]' alt='photo' src={companyData?.logoUrl} width={100} height={100}/>
                </TableCell>
              <TableCell align="left">{companyData?.companyName}</TableCell>
              <TableCell align="left">{companyData?.title.slice(0,60)}...</TableCell>      
              <TableCell align="left">{companyData?.address.slice(0,40)}...</TableCell>      
              <TableCell align="left">{companyData?.phone}</TableCell>      
              <TableCell align="left">{companyData?.email}</TableCell>      
              <TableCell align="left">{companyData?.websiteUrl}</TableCell>      
              <TableCell align="left">{new Date(companyData?.updatedAt).toLocaleDateString()}</TableCell>
            </TableRow>
