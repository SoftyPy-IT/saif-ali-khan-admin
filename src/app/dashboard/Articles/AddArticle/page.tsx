...
const data:Partial<TArticle> ={
  title,shortDescription,description,publishedDate,imageUrl
}
...
<div onClick={()=>toggleDrawer(true)}  className='flex items-center flex-col justify-center p-5 border-2 bg-white h-[180px]'>
...
<TextField required   value={title}
  onChange={(e) => setTitle(e.target.value)}  
   name='title' className='w-full mb-5 bg-white' id="outlined-basic" label="Title" variant="outlined" />
...
type="date" name="publishedDate"  className='w-full bg-white py-3  text-gray-700  px-3'/>
</label>
</div>
